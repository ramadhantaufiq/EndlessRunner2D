...
{
    [Header("Templates")]
    public List<TerrainTemplate> terrainTemplates;
    ...
    public List<TerrainTemplate> earlyTerrainTemplates;
    ...
    private void Start()
    {
        ...
        foreach (TerrainTemplate terrain in earlyTerrainTemplates)
        {
    ...
    private void GenerateTerrain(float posX, TerrainTemplate forceTerrain = null)
    {
